...
existing_status_cake_file = open('./files/statuscake/tls_cert/tls_cert_export.csv')
all_results_file = open('./files/statuscake_tls_cert_results.csv', 'w', newline="")
good_results_file = open('./files/statuscake/tls_cert/good_results.csv', 'w', newline="")
bad_results_file = open('./files/statuscake/tls_cert/bad_results.csv', 'w', newline="")
already_existed_file = open('./files/statuscake/tls_cert/already_existed.csv', 'w', newline="")
create_tests_file = open('./files/statuscake/tls_cert/create_test.csv', 'w', newline="")
